        ...
        <div class="print-section">
            ...
            <table cellpadding="0" cellspacing="0" style="width:100%">
                <tr>
                    ...
                    <td align="left" class="txt-left">&nbsp;<?= $data['no_faktur']; ?></td>
                </tr>
                <tr>
                    <td align="left" class="txt-left">Kasir</td>
                    <td align="left" class="txt-left">:</td>
                    <td align="left" class="txt-left">&nbsp;<?= $data['nama']; ?></td>
                </tr>
                <tr>
                    <td align="left" class="txt-left">Tgl.&nbsp;</td>
                    <td align="left" class="txt-left">:</td>
                    <td align="left" class="txt-left">&nbsp;<?= $data['tanggal_transaksi']; ?></td>
                </tr>
            ...
            <table cellpadding="0" cellspacing="0" style="width:100%">
                ...
                <?php foreach ($vir as $v) : ?>
                    <tr>
                        <td align="left" class="txt-left"><?= $v['nama_produk']; ?></td>
                        <td align="left" class="txt-left"><?= $v['qyt']; ?></td>
                        <td align="left" class="txt-left"><?= $v['harga_produk']; ?></td>
                        <td align="left" class="txt-left"><?= $v['total']; ?></td>
                    </tr>
                <?php endforeach; ?>
            </table>
            ...
            <table cellpadding="0" cellspacing="0" style="width:100%">
                <tr>
                    ...
                    <td align="left" class="txt-left"><?= $data['pembayaran']; ?></td>
                </tr>
                <tr>
                    <td align="left" class="txt-left" width="80%">Kembalian</td>
                    <td align="left" class="txt-left"><?= $data['kembalian']; ?></td>
                </tr>
                <tr>
                    <td align="left" class="txt-left">Diskon</td>
                    <td align="left" class="txt-left"><?= $data['diskon']; ?></td>
                </tr>

                <tr>
                    <td align="left" class="txt-left">Grand&nbspTotal</td>
                    <td align="left" class="txt-left"><?= $data['total']; ?></td>
                </tr>
